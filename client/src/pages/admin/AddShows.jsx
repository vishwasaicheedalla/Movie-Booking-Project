...
const AddShows = () => {
  ...
  return nowPlayingMovies.length > 0 ? (
    <>
      ...
      <p className="mt-10 text-lg font-medium">Now Showing</p>
      ...
      <div className="mt-8">
        ...
        <div className="inline-flex items-center gap-2 border border-gray-600 px-3 py-1.5 rounded-md">
      ...
      <div className="mt-6">
        ...
        <div className="inline-flex gap-5 border border-gray-600 p-1 pl-3 rounded-lg">
          ...
          <button onClick={handleDateTimeAdd} className="bg-gray-500/70 text-white px-2 py-1.5 text-sm rounded-lg hover:bg-gray-500 cursor-pointer" >
            Add Time
          </button>
        </div>
      </div>
            ...
            {Object.entries(dateTimeSelection).map(([date, times]) => (
              <li key={date}>
                ...
                <div className="flex flex-wrap gap-2 mt-1 text-sm">
                  {times.map((time) => (
                    <div key={time} className="border border-red-500 px-2 py-1 flex items-center rounded" >
                      <span>{time}</span>
      ...
      <button onClick={handleSubmit} disabled={addingShow} className="bg-red-500 text-white px-4 py-2 mt-6 rounded-lg hover:bg-red-500/70 transition-all cursor-pointer" >
        Add Show
      </button>
    </>
  ) : <Loading />
